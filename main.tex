...
which then gives
\begin{equation} 
V_\pi( \mathbf{r}) = - \frac{g_A^2 }{4 F_\pi^2} \taudot \left(\frac{m_\pi^3}{4 \pi}\right) \left\{ - \sqrt{\frac{15}{8\pi}} [\sigma_1 \otimes \sigma_2]_2 \cdot Y_2(\hat{r}) w(2,1,2; m_\pi r) + \frac{1}{3} \sigma_1 \cdot \sigma_2 w(2,1,0; m_\pi r ) \right\},  \end{equation}
...
\begin{equation}
S_{12} \equiv   3\vec{\sigma}_1\cdot \hat{r}\vec{\sigma}_2\cdot \hat{r} -\sigmadot = 3\:\sqrt{\frac{15}{8\pi}} \:[\sigma_1 \otimes \sigma_2]_2 \cdot Y_2(\hat{r}) , 
\end{equation}
we have
