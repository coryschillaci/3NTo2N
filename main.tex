...
\begin{equation}\begin{split}
 ...
 & +3 \Big[ G_{0,I=1}(k/2,k'/2)+G_{1,I=1}(k/2,k'/2)) \Big] \\
 ...
 & -\tau_1^3 \Big[ G_{0,I=1}(k/2,k'/2)+G_{1,I=1}(k/2,k'/2)) \Big]
 \end{split}
 \end{equation}
Where
\begin{align}
...
%
G_{1,N}(k,k') & = \frac{1}{m_\pi^3}\int\frac{d^3\vec{k}_\delta}{(2\pi)^3} n_{N,P}(k_\delta) \frac{i\sigma_1\cdot\left[(\vec{k}'-\vec{k})\times(\vec{k}-\vec{k}_\delta)\right] }{[(\vec{k}-\vec{k}_\delta)^2+m_\pi^2][(\vec{k'}-\vec{k}_\delta)^2+m_\pi^2]}
\end{align}
